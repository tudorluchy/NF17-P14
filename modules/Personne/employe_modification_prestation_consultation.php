...
<form  enctype="multipart/form-data" name="inscription" action="?module=Personne&action=validation_employe_modification_prestation_consultation" method="POST">
	<fieldset>
		
		<label for="nom">Nom :</label>
		<input name="nom" type="text" id="nom" value="<?php if (isset($prestation)) echo $prestation['nom'];?>">

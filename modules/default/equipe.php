...
<ul>
    ...
    <li>GI02</li>
    <li>Diplômé de l'IUT d'Informatique d'Amiens (juin 2013)</li>
    <li>Organisateur du Hackathon</li>
</ul>
...
<ul>
    <li>Etudiant à l'UTC</li>
    <li>GI02</li>
    <li>Chefetain chez les Scouts et Guides de France</li>
	<li>Président de Lan'UTC</li>
</ul>
...
<ul>
    ...
    <li>GI02</li> 
	<li>Membre d'Ignénieurs Sans Frontière</li>
</ul>